...
namespace __Interop
{
	...
	public unsafe static partial class kernel32_dll
	{
		...
		// Signature, GetModuleFileNameEx, [fwd] [return] [EETypeRva:0x000419B0] int__int, [fwd] [in] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, [fwd] [in] [EETypeRva:0x000419B0] System_IntPtr____w64 int, [fwd] [out] [EETypeRva:0x00042A40] rg_char__wchar_t *, [fwd] [in] [EETypeRva:0x000419B0] int__int, 
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("System.Diagnostics.Process, Version=4.2.1.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "Interop+Kernel32", "GetModuleFileNameEx")]
		public static int GetModuleFileNameEx(
					global::Microsoft.Win32.SafeHandles.SafeProcessHandle__System_Diagnostics_Process processHandle, 
					global::System.IntPtr moduleHandle, 
					char[] baseName, 
					int size)
		{
			// Setup
			bool addRefed = false;
			ushort* unsafe_baseName;
			int unsafe___value;
			// Marshalling
			processHandle.DangerousAddRef(ref addRefed);
			fixed (char* pinned_baseName = ((baseName != null 
						&& baseName.Length == 0) ? new char[1] : baseName))
			{
				unsafe_baseName = (ushort*)pinned_baseName;
				global::System.Runtime.InteropServices.McgMarshal.ClearLastWin32Error();
				// Call to native method
				unsafe___value = global::__Interop.kernel32_dll_PInvokes.GetModuleFileNameEx(
		...
		// Signature, GetCurrentProcess__0, [fwd] [return] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, 
		...
		public static global::Microsoft.Win32.SafeHandles.SafeProcessHandle__System_Diagnostics_Process GetCurrentProcess__0()
		{
			// Setup
	...
	public unsafe static partial class advapi32_dll
	{
		...
		// Signature, OpenProcessToken__0, [fwd] [return] [EETypeRva:0x00040848] bool__System.Boolean, [fwd] [in] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, [fwd] [in] [EETypeRva:0x000419B0] int__int, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeTokenHandle__System_Diagnostics_Process____w64 int, 
	...
	public unsafe static partial class kernel32_dll_PInvokes
	{
		...
		[global::System.Runtime.InteropServices.DllImport("kernel32.dll", EntryPoint="K32GetModuleFileNameExW", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static int GetModuleFileNameEx(
